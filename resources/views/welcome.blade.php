    ...
    <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
      <div class="lg:pt-4 lg:pr-8">
        <div class="lg:max-w-lg">
          <h2 class="text-base/7 font-semibold text-indigo-400">Selamat Datang di Parkir App</h2>
          <p class="mt-2 text-4xl font-semibold tracking-tight text-pretty text-white sm:text-5xl">Solusi Parkir Modern</p>
          <p class="mt-6 text-lg/8 text-gray-300">Ucapkan selamat tinggal pada kesulitan mencari tempat parkir. Dengan Parkir App, temukan dan bayar parkir menjadi lebih mudah, cepat, dan efisien.</p>
          <dl class="mt-10 max-w-xl space-y-8 text-base/7 text-gray-400 lg:max-w-none">
            <div class="relative pl-9">
              ...
              <dd class="inline">Lihat informasi ketersediaan slot parkir secara real-time langsung dari aplikasi Anda sebelum berangkat.</dd>
            </div>
            <div class="relative pl-9">
              <dt class="inline font-semibold text-white">
                <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden="true" class="absolute top-1 left-1 size-5 text-indigo-400">
              ...
              <dd class="inline">Nikmati kemudahan pembayaran parkir menggunakan berbagai metode digital yang cepat dan aman.</dd>
            </div>
            <div class="relative pl-9">
              <dt class="inline font-semibold text-white">
                <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden="true" class="absolute top-1 left-1 size-5 text-indigo-400">
              ...
              <dd class="inline">Daftarkan dan kelola semua kendaraan Anda dalam satu akun untuk transaksi yang lebih cepat.</dd>
            </div>
          </dl>
        </div>
      </div>
      <img width="2432" height="1442" src="{{ asset('images/parked-logo.png') }}" alt="Logo Aplikasi Parkir" class="w-3xl max-w-none rounded-xl shadow-xl ring-1 ring-white/10 sm:w-228 md:-ml-4 lg:-ml-0" />
    </div>
  </div>
</div>
