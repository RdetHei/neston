...
<div class="max-w-2xl mx-auto px-4">
    <h2 class="text-3xl font-bold mb-6 text-gray-800">Buat Transaksi Baru</h2>
    ...
    <form action="{{ route('transaksi.store') }}" method="POST" class="bg-white p-6 rounded shadow-lg">
        @csrf
        ...
        <div class="mb-5">
            <label class="block text-sm font-semibold text-gray-700 mb-2">Waktu Masuk <span class="text-red-600">*</span></label>
            <input type="datetime-local" name="waktu_masuk" required value="{{ old('waktu_masuk') }}" 
                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
            @error('waktu_masuk')<div class="text-red-600 text-sm mt-1">{{ $message }}</div>@enderror
        </div>
        ...
        <div class="mb-5">
            <label class="block text-sm font-semibold text-gray-700 mb-2">User <span class="text-red-600">*</span></label>
            <select name="id_user" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
        ...
        <div class="mb-5">
            <label class="block text-sm font-semibold text-gray-700 mb-2">Area <span class="text-red-600">*</span></label>
